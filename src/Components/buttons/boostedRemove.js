    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            guild.members.fetch(interaction.user.id).then(member => {
                if (!member.roles.cache.has("1098772014216523857")) return interaction.reply({ embeds: [errEm.setDescription("You don't have this role")], ephemeral: true })
                member.roles.remove("1098772014216523857")
