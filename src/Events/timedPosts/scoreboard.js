...
module.exports = {
	...
	execute(client) {
		let timer = setInterval(function () {
			const sqlQuery = `SELECT * FROM discman.posts WHERE slug = 'scoreboard'`;
		...
		function setScoreboard(messageID, channelID, client, guildId, MsgKey) {
			...
			const sqlQuery1 = `SELECT PlayTime, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY PlayTime DESC LIMIT 5`;
			const sqlQuery2 = `SELECT DinoKills, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY DinoKills DESC LIMIT 5`;
			const sqlQuery3 = `SELECT WildDinoKills, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY WildDinoKills DESC LIMIT 5`;
			const sqlQuery4 =
				"SELECT DeathByPlayer, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY DeathByPlayer DESC LIMIT 5";
			const sqlQuery5 = `SELECT PlayerKills, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY PlayerKills DESC LIMIT 5`;
			const sqlQuery6 = `SELECT DeathByWildDino, PlayerName FROM advanced_achievements.advancedachievements_playerdata ORDER BY DeathByWildDino DESC LIMIT 5`;
