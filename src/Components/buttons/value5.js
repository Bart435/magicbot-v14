...
module.exports = {
	name: 'value5',
	customID: 'value5',
	description: 'value 5 of exchange',
	async execute(interaction, client) {
		...
		// setting amount
		let dcamount = client.config.walletSystem.value_5
		let amount = client.config.walletSystem.value_5 / client.config.walletSystem.ratio
